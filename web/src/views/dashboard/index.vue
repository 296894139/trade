    ...
    <el-row :gutter="40" class="panel-group">
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('newVisitis')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">专家数量</div>
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('purchases')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">需求数量</div>
...
export default {
  ...
  created() {
    axios({
      method: 'get',
      url: config.baseApi + "user/find/identity?identity=worker&page=0"+"&size=1000000",
      headers:{
    ...
    axios({
      method: 'get',
      url: config.baseApi + "user/find/identity?identity=boss&page=0"+"&size=1000000",
      headers:{
        "X-Litemall-Admin-Token":sessionStorage.getItem('token')
      }
    }).then(response => {
    ...
    axios({
      method: 'get',
      url: config.baseApi + "goods/find/ShopId?ShopId=demand&page=0"+"&size=1000000",
      headers:{
        "X-Litemall-Admin-Token":sessionStorage.getItem('token')
      }
    }).then(response => {
    ...
    axios({
      method: 'get',
      url: config.baseApi + "goods/find/ShopId?ShopId=news&page=0"+"&size=1000000",
      headers:{
        "X-Litemall-Admin-Token":sessionStorage.getItem('token')
      }
    }).then(response => {
