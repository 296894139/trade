<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="赊账全额" prop="invest"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="赊账全额" prop="invest">
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        axios({
          method: 'get',
          url: config.baseApi + "user/find/identity?identity=shareholder&page="+ (this.listQuery.page-1)+"&size=20",
          headers:{
      ...
      handleFilter() {
        ...
        axios({
          method: 'get',
          url: config.baseApi + "user/find/identity/query?identity=shareholder&query="+this.listQuery.key+"&page="+ (this.listQuery.page-1)+"&size=20",
          headers:{
            "X-Litemall-Admin-Token":sessionStorage.getItem('token')
          }
        }).then(response => {
