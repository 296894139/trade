<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="宣传标题" prop="name"/>

      <el-table-column align="center" label="宣传简介" prop="brief"/>
    ...
    <el-dialog customClass="customWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style=" margin-left:50px;">
        ...
        <el-form-item label="宣传简介" prop="brief">
  ...
  export default {
    ...
    methods: {
      getList() {
        axios({
          method: 'get',
          url: config.baseApi + "goods/find/ShopId?ShopId=ad&page="+ (this.listQuery.page-1)+"&size=20",
          headers:{
