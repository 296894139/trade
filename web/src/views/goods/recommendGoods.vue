<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="新闻标题" prop="name"/>

      <el-table-column align="center" label="新闻简介" prop="brief"/>
  ...
  export default {
    ...
    methods: {
      getList() {
        axios({
          method: 'get',
          url: config.baseApi + "goods/find/ShopId?ShopId=news&page="+ (this.listQuery.page-1)+"&size=20",
          headers:{
