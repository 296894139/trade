...
public class Goods {//商品
    ...
    @Column(name = "name")
    private String name; //信息标题

    @Column(name = "brief")
    private String brief; //信息简介

    @Column(name = "shopId")
    private String shopId; //类别：demand、news、inform、activity、ad

    @Column(name = "standard")
    private String standard; //行业id
    ...
    private String discountId; //发布时间
