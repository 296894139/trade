...
class SMTP
{
    ...
    public function connect($host, $port = null, $timeout = 30, $options = [])
    {
        ...
        if ($streamok) {
            ...
            //Fall back to fsockopen which should work in 更多 places, but is missing some features
            $this->edebug(
    ...
    public function authenticate(
        ...
        if (array_key_exists('EHLO', $this->server_caps)) {
            ...
            if (empty($authtype)) {
                ...
                //Try CRAM-MD5 first as it's 更多 secure than the others
    ...
    public function data($msg_data)
    {
         ...
         * According to rfc821 we should not send 更多 than 1000 characters on a single line (including the LE)
     ...
     * the mail transaction is started and then one or 更多 recipient
     ...
     * @param integer|array $expect One or 更多 expected integer success codes
     *
     * @return boolean True on success.
     */
     ...
     * With SMTP we can tell if we have 更多 lines to read if the
