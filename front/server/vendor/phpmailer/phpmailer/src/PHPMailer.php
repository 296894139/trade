...
class PHPMailer
{
    ...
    /**
     * Parse and validate a string containing one or 更多 RFC822-style comma-separated email addresses
     ...
     *
     * @return array
     * @see    http://www.andrew.cmu.edu/user/agreen1/testing/mrbs/web/Mail/RFC822.php A 更多 careful implementation
     */
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'pcre8':
                /**
                 * A 更多 complex and 更多 permissive version of the RFC5322 regex on which FILTER_VALIDATE_EMAIL
                 * is based.
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        if ($matchcount > strlen($str) / 3) {
            // 更多 than a third of the content will need encoding, so B encoding will be most efficient
            $encoding = 'B';
            //This calculation is:
            // max line length
            ...
            //1 or 更多 chars need encoding, use Q-encode
            $encoding = 'Q';
    ...
    public function encodeQ($str, $position = 'text')
    {
        ...
        // Replace spaces with _ (更多 readable than =20)
     ...
     * You should avoid this function - it's 更多 verbose, less efficient, 更多 error-prone and
